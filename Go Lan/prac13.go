// Develop a generic container that can hold and operate on values of different types using interfaces. 
// Allow users to add, retrieve, and perform operations on elements stored in the container, 
