// Extend the bank account program from the previous example to handle errors. Implement error 
// checks for scenarios like insufficient funds during withdrawals or invalid inputs during deposits. 
